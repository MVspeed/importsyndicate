...
const SITE = {
  ...
  "checkout": {
    ...
    "privacyNote": "Нажимая кнопку, ты соглашаешься с политикой конфиденциальности. Мы не передаём данные третьим лицам.",
    "successTitle": "Заказ оформлен!",
    "successSubtitle": "Мы получили твой заказ. Чек отправлен на твою почту. Менеджер свяжется в течение 15 минут для подтверждения.",
